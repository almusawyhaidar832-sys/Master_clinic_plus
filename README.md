...
| الملف | الجمهور |
|-------|---------|
| [`docs/دليل-المستخدم.html`](docs/دليل-المستخدم.html) | **دليل المستخدم للعميل** — افتحه واطبعه كـ PDF |
| [`docs/دليل-المستخدم-ماستر-كلينك-بلس.md`](docs/دليل-المستخدم-ماستر-كلينك-بلس.md) | نفس الدليل بصيغة Markdown (للتعديل) |
| [`docs/كيفية-طباعة-الدليل-PDF.md`](docs/كيفية-طباعة-الدليل-PDF.md) | طريقة تصدير PDF |
| [`docs/Nشر_بسيط.md`](docs/Nشر_بسيط.md) | نشر على Vercel (للمطوّر) |
| [`docs/WHATSAPP_EVOLUTION_SETUP.md`](docs/WHATSAPP_EVOLUTION_SETUP.md) | إعداد واتساب (للمطوّر) |
