-- إصلاح خصم الرواتب في اللوحة — paid_net_payout (أجر يومي)
-- استثناء expense_kind=doctor_salary من المصروفات (تُخصم عبر حركات doctor_salary_paid)
-- شغّل بعد 33-payroll-paid-portions.sql
