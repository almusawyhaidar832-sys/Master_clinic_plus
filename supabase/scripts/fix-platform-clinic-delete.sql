-- =============================================================================
-- إصلاح فشل حذف العيادة من لوحة المطور
-- أخطاء محتملة:
--   • null value in column "doctor_share_total" of relation "patients"
--   • null value in column "doctor_id" of relation "patient_operations"
