-- Run once in Supabase SQL Editor if migration was not applied via CLI
-- Adds booking_code for public booking portal + QR
...
SELECT id, name_ar, name, booking_code FROM public.clinics ORDER BY created_at;
