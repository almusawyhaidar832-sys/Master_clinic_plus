-- لوحة التحكم التنفيذية: خصم رواتب الموظفين المدفوعة من صافي الربح
-- شغّل في Supabase → SQL Editor بعد تأكيد صرف قسائم الراتب (status = paid)

-- إصلاح قسائم مدفوعة بدون تاريخ صرف
