-- تشغيل يدوي في Supabase SQL Editor (انسخ والصق كاملاً ثم Run)
-- يتطلب عمود doctors.payment_type (migration 20260610000000_doctor_payment_type.sql)
-- أطباء الراتب الثابت: حصة الطبيب 0 — كامل المبلغ لحصة العيادة
