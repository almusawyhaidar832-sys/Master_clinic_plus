-- لوحة التحكم: إظهار كشفيات المراجع — شغّل في Supabase SQL Editor
-- (يشمل أيضاً رواتب + استثناء أشهر التصفير — نفس دالة اللوحة الكاملة)

-- انسخ من: supabase/migrations/20260603240000_executive_review_fees.sql
-- أو شغّل هذا الملف إذا كان محدّثاً أدناه:
