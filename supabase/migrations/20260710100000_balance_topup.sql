-- شحن رصيد العيادة / الطبيب — يُسجّل في transactions ويُ reflected في الربح والمحفظة
...
-- إضافة شحن رصيد العيادة إلى صافي الربح في اللوحة التنفيذية
...
BEGIN
  ...
  v_net_profit := v_clinic_shares + v_review_fees - v_expenses + v_balance_topups;
